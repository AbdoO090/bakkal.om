(function ($) {
    ...
    $('#shipping_state').on('change', function() {
        var selectedOption = $('#shipping_state option:selected');
        var state = selectedOption.data('id');
        $.ajax({
            url: $('#get-cities').data('url'),
            method: "POST",
            data: {
                state: state,
                _token: _token,
            ...
            success: function(data) {
                ...
                $.each(data, function(index, value) {
                    options += '<option value="' + value.name_en + '">' + value.name_ar + '</option>';
