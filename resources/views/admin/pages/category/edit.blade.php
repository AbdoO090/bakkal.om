                ...
                <div class="gallery__content">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-one" role="tabpanel" aria-labelledby="nav-one-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    @if ($edit->id == 1 || $edit->id == 4 || $edit->id == 6 || $edit->id == 7)
                                    <h2 class="text-center">{{ __('This category appears on the home page') }}</h2>
                                    @endif
                                        ...
                                        <form enctype="multipart/form-data" method="POST"
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="fr_category_name" name="fr_category_name"
                                                    value="{{ $edit->fr_Category_Name }}" placeholder="Name (Arabic)">
                                            </div>
                                            <div class="input__group mb-25">
                                            ...
                                            <div class="input__group mb-25">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" value="1" name="inHome"
                                                        class="custom-control-input" id="customSwitch1"  {{$edit->inHome ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
                                                        for="customSwitch1">{{ __('In Home Page') }}</label>
                                                </div>
                                                @error('inHome')
