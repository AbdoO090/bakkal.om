                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <span
                                                style="color: red">{{ __('The recommended dimensation is 545 * 656, with size less than 2 MB') }}</span>
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <span
                                                style="color: red">{{ __('The recommended dimensation is 1920 * 680, with size less than 2 MB') }}</span>
