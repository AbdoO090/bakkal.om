        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item " aria-current="page"><a
                        href="{{ route('admin.advertise') }}">{{ __('Advertise') }}</a></li>
            </ol>
        </div>
        <div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <a href="{{ route('admin.advertise') }}"
                                class="btn btn-md btn-info text-right">{{ __('All Advertise') }}</a>
                        </div>
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <span
                                        style="color: red">{{ __('The recommended dimensation is 645*645, with size less than 2 MB') }}</span>
