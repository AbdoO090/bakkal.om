                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <input type="hidden" name="product_type" value="{{PRODUCT_LICENSE}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input__group mb-25">
                                                        <label for="digital-type">{{ __('Select Type')}}</label>
                                                        <select name="digital_type" id="digital-type" class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input__group mb-25">
                                                        <label for="license-name">{{ __('License Name')}}</label>
                                                        <input type="text" class="form-control" name="license_name" id="license-name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="input__group mb-25">
                                                        <label for="license-key">{{ __('License Key')}}</label>
                                                        <input type="text" class="form-control" name="license_key" id="license-key">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
