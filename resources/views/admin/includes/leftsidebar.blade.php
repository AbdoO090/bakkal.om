...
<div class="sidebar__area">
    ...
    <div class="sidebar__brand text-center">
        <a href="{{ route('admin.dashboard') }}">
            <img src="{{ asset(IMG_LOGO_PATH . $allsettings['footer_logo']) }}" alt="icon" width="30%">
        </a>
    </div>
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        <li class="{{ isset($menu) && $menu == 'delivery_charge' ? 'mm-active' : '' }}">
            ...
            <ul>
                <li class="{{ isset($submenu) && $submenu == 'states_list' ? 'mm-active' : '' }}">
                    <a href="{{ route('admin.statesList') }}">
                        <i class="fa fa-circle"></i>
                        <span>{{ __('Governorate List') }}</span>
                    </a>
                </li>
                <li class="{{ isset($submenu) && $submenu == 'cities_list' ? 'mm-active' : '' }}">
                    <a href="{{ route('admin.citiesList') }}">
                        <i class="fa fa-circle"></i>
                        <span>{{ __('states List') }}</span>
                    </a>
                </li>
            </ul>
        </li>
