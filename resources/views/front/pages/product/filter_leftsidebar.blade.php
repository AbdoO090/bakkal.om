    ...
    @foreach ($filters as $product)
        <div class="single-list-product">
            <div class="product-left">
                <a href="{{ route('single.product', $product->en_Product_Slug) }}"><img class="product-thumbnal"
            ...
            <div class="product-right">
                ...
                <ul class="prdouct-btn-wrapper d-flex align-items-center">
                    ...
                    <li class="single-product-btn">
                        <a class="product-btn MyWishList" title="{{ __('Add To Wishlist') }}"
                            data-id="{{ $product->id }}"><i class="icon flaticon-like"></i></a>
                    </li>
                    <li class="single-product-btn">
