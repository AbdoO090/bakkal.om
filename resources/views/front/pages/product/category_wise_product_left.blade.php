    ...
    <div class="breadcrumb-area">
        <div class="container">
            <div class="breadcrumb-wrap text-center">
                <h2 class="page-title">{{ langConverter($category_m->en_Category_Name, $category_m->fr_Category_Name) }}</h2>
                <ul class="breadcrumb-pages">
                    <li class="page-item"><a class="page-item-link" href="{{ route('front') }}">{{ __('Home') }}</a></li>
                    <li class="page-item">{{ langConverter($category_m->en_Category_Name, $category_m->fr_Category_Name) }}
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="categories-list">
                                @foreach ($category as $cateogories)
                                    <div class="single-categorie">
                                        ...
                                        @else
                                        <input class="form-check-input CheckCategory" type="checkbox"
                                        value="{{ $cateogories->fr_Category_Name }}">
                                    <label class="form-check-label">{{ $cateogories->fr_Category_Name }}</label>
                                        @endif
                                        </div>
                                ...
                                <div class="product-section-top-left">
                                    ...
                                    <div class="list-grid-view">
                                        <a href="{{ route('category.product_left', $category_m->id) }}"
                                            class="view-btn list-view active"><img class="view-icon"
                                                src="{{ asset('frontend/assets/images/view-list.svg') }}"
                                                alt="view-list" /></a>
                                        <a href="{{ route('brand.product', $category_m->id) }}"
                                            class="view-btn grid-view"><img class="view-icon"
                                    ...
                                    <form>
                                        <select class="form-select sortingFilter">
                                            ...
                                            @foreach (Category() as $item)
                                                <option value="{{ route('category.product_left', $item->id) }}">
                                ...
                                <div class="single-list-product">
                                    ...
                                    <div class="product-right">
                                        ...
                                        <div class="product-price-color d-flex align-items-center">
                                            ...
                                            id="product_quantity">
                                        <p class="prdouct-content">
                                            {{ langConverter($product->en_About, $product->fr_About) }}</p>
