        ...
        <div class="section-header-area">
            <div class="row">
                ...
                <div class="col-md-6 align-self-end text-md-end">
                    <a href="{{ route('all.product') }}" class="primary-btn">{{ __('View All Categories') }}</a>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <a class="single-categorie" href="{{ route('category.product', $item->id) }}">
                        <div class="categorie-wrap">
                            <div class="categorie-icon">
                                <img src="https://store.oldbazaar-om.com/uploaded_files/product_image/64a69721cdb531688639265.png"
                                    alt="">
...
<div class="featured-productss-area section-top pb-50">
    <div class="container">
        <div class="section-header-area">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h2 class="section-title">
                        {{ __('DESSERT AND CONFECTIONARY') }} </h2>
                </div>
                <div class="col-md-6 align-self-end text-md-end">
                    <a href="{{ route('category.product', 6) }}" class="see-btn">{{ __('See All') }}</a>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container">
        <div class="section-header-area">
            <div class="row">
                ...
                <div class="col-md-6 align-self-end text-md-end">
                    <a href="{{ route('category.product', 1) }}" class="see-btn">{{ __('See All') }}</a>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="section-header-area">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h2 class="section-title">
                        {{ __('TURKISH DELIGHT') }} </h2>
                </div>
                <div class="col-md-6 align-self-end text-md-end">
                    <a href="{{ route('category.product', 4) }}" class="see-btn">{{ __('See All') }}</a>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="section-header-area">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h2 class="section-title">
                        {{ __('BAKERY and PASTRY') }} </h2>
                </div>
                <div class="col-md-6 align-self-end text-md-end">
                    <a href="{{ route('category.product', 7) }}" class="see-btn">{{ __('See All') }}</a>
                </div>
            </div>
        </div>
        <div class="row">
