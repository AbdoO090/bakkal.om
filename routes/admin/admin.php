...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'is_admin', 'en.locale'], 'as' => 'admin.'], function () {
    ...
    Route::group(['prefix' => 'product'], function () {
        ...
        Route::get('image/delete/{id}', [ProductController::class, 'ImageDelete'])->name('image.delete')->middleware(['permission:product-delete', 'isDemo']);
    ...
    //Delivery Charge
    Route::get('/states-list', [EcommerceController::class, 'statesList'])->name('statesList')->middleware(['permission:delivery-charge-list']);
    Route::post('/states-store', [EcommerceController::class, 'StatesStore'])->name('States_store')->middleware(['permission:delivery-charge-list']);
    Route::post('/states-update/{id}', [EcommerceController::class, 'States_update'])->name('States_update')->middleware(['permission:delivery-charge-list']);
    Route::get('/states-delete/{id}', [EcommerceController::class, 'States_delete'])->name('States_delete')->middleware(['permission:delivery-charge-list']);

    Route::get('/cities-list', [EcommerceController::class, 'citiesList'])->name('citiesList')->middleware(['permission:delivery-charge-list']);
    Route::post('/cities-store', [EcommerceController::class, 'citiesStore'])->name('citiesStore')->middleware(['permission:delivery-charge-list']);
    Route::post('/cities-update/{id}', [EcommerceController::class, 'cities_update'])->name('cities_update')->middleware(['permission:delivery-charge-list']);
    Route::get('/cities-delete/{id}', [EcommerceController::class, 'cities_delete'])->name('cities_delete')->middleware(['permission:delivery-charge-list']);
