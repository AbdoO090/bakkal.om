...
Route::get('artisan-command', function () {
    $op = \Illuminate\Support\Facades\Artisan::call("optimize");
    echo "done  $op";
});
...
Route::get('/payment/callback/success', [PaymentCallbackController::class, 'success'])->name('payment.success');
Route::get('/payment/callback/cancel', [PaymentCallbackController::class, 'cancel'])->name('payment.cancel');
