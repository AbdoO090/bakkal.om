...
class CategoryController extends Controller
{
    public function category(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->editColumn('appears on the home page', function ($data) {
                    if ($data->id == 1 || $data->id == 4 || $data->id == 6 || $data->id == 7) {
                        $active = "Yes";
                        return '<span class="status active">' . $active . '</span>';
                    } else {
                        $active = "No";
                ...
                ->rawColumns(['action', 'Category_Name', 'Category_Slug', 'Status', 'Description','appears on the home page'])
                ->make(true);
        }
    ...
    public function categoryStore(CategoryRequest $request)
    {
        $category = Category::create([
            ...
            'inHome' => checkBoxValue($request->inHome),
